...
gem 'hanami-validations', '1.1.0.beta2', git: 'https://github.com/hanami/validations.git', branch: 'develop'
gem 'hanami-controller',  '1.1.0.beta2', git: 'https://github.com/hanami/controller.git',  branch: 'develop'
