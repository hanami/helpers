...
**This branch contains the code for `hanami-helpers` 1.3.x.**

## Status

[![Gem Version](https://badge.fury.io/rb/hanami-helpers.svg)](https://badge.fury.io/rb/hanami-helpers)
[![CI](https://github.com/hanami/helpers/workflows/ci/badge.svg?branch=1.3.x)](https://github.com/hanami/helpers/actions?query=workflow%3Aci+branch%3A1.3.x)
[![Test Coverage](https://codecov.io/gh/hanami/helpers/branch/1.3.x/graph/badge.svg)](https://codecov.io/gh/hanami/helpers)
